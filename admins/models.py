...
class AccountManager(BaseUserManager):
    ...
    def create_superuser(self,first_name,last_name,phone_number,email,username,password = None):
        ...
        user = self.create_user(email =self.normalize_email(email),first_name = first_name,last_name = last_name,username = username,phone_number = phone_number,password = password)
        user.is_admin = True
        user.is_active = True
        user.is_staff = True
